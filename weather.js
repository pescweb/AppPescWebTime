...
GLoc = {
    ...
    geoSuccess: function(position, method) {
        ...
        g.searchQuery = 'http://api.openweathermap.org/data/2.5/weather?lat=' + latitude + '&lon=' + longitude + '&appid=044eb19cba7f5d9a175ed6c4adf3bb69' +'&lang=' + g.lang;
...
WeatherInfo = {
    ...
    getWeatherData: function(searchQuery) {
        if (w.searchLocationInput.val() !== '') {
            w.searchQuery = 'http://api.openweathermap.org/data/2.5/weather?q=' + w.searchLocationInput.val() + '&appid=044eb19cba7f5d9a175ed6c4adf3bb69' + '&lang=' + g.lang;
    ...
    getWeatherDirection: function() {
        if (w.windDegree > 337.5 || w.windDegree <= 22.5) {
            ...
            w.windDirection.text('L');
        } else if (112.5 < w.windDegree <= 157.5) {
            w.windDirection.text('SD');
            ...
            w.windDirection.text('O');
        } else if (292.5 < w.windDegree <= 337.5) {
            w.windDirection.text('NO');
        }
